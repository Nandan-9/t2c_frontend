  ...
  return (
    <div ref={wrapperRef} className="relative">
      <input
        ...
        className="border border-gray-300 rounded px-3 py-1.5 text-sm outline-none focus:ring-2 focus:ring-[#C92A2A]/30 w-48"
      />
      {loading && (
        <div className="absolute right-3 top-2 w-4 h-4 border-2 border-[#C92A2A] border-t-transparent rounded-full animate-spin" />
      )}
